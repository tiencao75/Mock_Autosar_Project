...
tcb_t OsCfg_TCBs[3/*num of app tasks*/+1/*for Idle mechanism */] = 
{
	...
	{/*SP*/0u, /*basic SP*/0u , /*task pointer*/OsTask_ProcessData_Task, 
	/*task state*/READY, /*DeadBeefLoc*/NULL, /*priority*/30, /*task model*/EXTENDED,
	/*set events*/0u, /*wait events*/0u, /*res occupation*/0u, 
	/*preemptability*/1u, /*schedule requested */0u},

	{/*SP*/0u, /*basic SP*/0u , /*task pointer*/OsTask_SendData_Task, 
	/*task state*/READY, /*DeadBeefLoc*/NULL, /*priority*/20, /*task model*/EXTENDED,
	/*set events*/0u, /*wait events*/0u, /*res occupation*/0u, 
	/*preemptability*/1u, /*schedule requested */0u},
...
{
	{/*fire time*/200, /*cyclic time*/100, /*call back*/NULL,
	/*action*/ALARM_ACTION_EVENT,
	/*base type*/&MainCounter, /*task id*/ReadSensor_Task, /*event id*/BE_Sensor,
	/*enable status*/true}		/*Alarm ID: Rte_ReadSensor_100ms*/
};
/*******************************************************************************
